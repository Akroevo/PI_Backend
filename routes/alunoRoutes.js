...
router.get('/sem-curso',     autorizar('superadmin', 'coordenador'), ctrl.getSemCurso);
...
router.delete('/:matricula/cursos/:idCurso', autorizar('superadmin', 'coordenador'), ctrl.removeCurso);
